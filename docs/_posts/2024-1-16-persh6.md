...
The two notions of $R\H om$ agree with each other up to isomorphism; applying $R\H om(\mc F,-)$ to $\mc G$ gives you an object isomorphic to $R\H om(-, \mc G)$ applied to $\mc F$, so we denote either of these isomorphic objects by $R\Hom(\mc F,\mc G)$.
